...
//   const siteNameOptions = options.map(option => option.siteName);
//   const referenceOptionsList = referenceOptions;

//   useEffect(() => {
//     if (selectedValue !== null) {
//       const selectedOption = options.find((opt) => opt.siteName === selectedValue || opt.reference === selectedValue);
//       if (selectedOption) {
//         setEditValue(selectedOption.siteName || '');
